...
#define STORM_RTE_TUPLE_OPERATE_NUM_TUPLES                  (STORM_RTE_TUPLE_STAGECONFIG_CAPACITY_PERCENT+1) //!< Number of Elements
 ...
 */
class StageConfig: public Rte::Tuple::Basic<STORM_RTE_TUPLE_OPERATE_NUM_TUPLES>
{
public: 
