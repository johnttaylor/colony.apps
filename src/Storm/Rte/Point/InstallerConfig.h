#ifndef Storm_Rte_Point_InstallerConfig_h_
#define Storm_Rte_Point_InstallerConfig_h_
/*-----------------------------------------------------------------------------
...
#include "Storm/Rte/Tuple/PiConfig.h"
#include "Storm/Rte/Tuple/EquipConfig.h"
#include "Storm/Rte/Tuple/StageConfig.h"
...
#define STORM_RTE_POINT_INSTALLERCONFIG_PI_CONFIG           0  //!< Tuple Index
#define STORM_RTE_POINT_INSTALLERCONFIG_EQUIP_CONFIG        1  //!< Tuple Index
#define STORM_RTE_POINT_INSTALLERCONFIG_COMP_COOL_STAGE1    2  //!< Tuple Index
#define STORM_RTE_POINT_INSTALLERCONFIG_COMP_COOL_STAGE2    3  //!< Tuple Index
#define STORM_RTE_POINT_INSTALLERCONFIG_COMP_HEAT_STAGE1    4  //!< Tuple Index
#define STORM_RTE_POINT_INSTALLERCONFIG_COMP_HEAT_STAGE2    5  //!< Tuple Index
#define STORM_RTE_POINT_INSTALLERCONFIG_ELEC_HEAT_STAGE1    6  //!< Tuple Index
#define STORM_RTE_POINT_INSTALLERCONFIG_ELEC_HEAT_STAGE2    7  //!< Tuple Index
#define STORM_RTE_POINT_INSTALLERCONFIG_ELEC_HEAT_STAGE3    8  //!< Tuple Index
#define STORM_RTE_POINT_INSTALLERCONFIG_FOSSIL_HEAT_STAGE1  9  //!< Tuple Index
#define STORM_RTE_POINT_INSTALLERCONFIG_FOSSIL_HEAT_STAGE2  10 //!< Tuple Index
#define STORM_RTE_POINT_INSTALLERCONFIG_FOSSIL_HEAT_STAGE3  11 //!< Tuple Index
#define STORM_RTE_POINT_INSTALLERCONFIG_NUM_TUPLES          (STORM_RTE_POINT_INSTALLERCONFIG_FOSSIL_HEAT_STAGE3+1)  //!< Number of Tuples
...
public:
    ...
    InstallerConfig( void )
        {
        registerTuple( STORM_RTE_POINT_INSTALLERCONFIG_PI_CONFIG,          m_piConfig         );              
        registerTuple( STORM_RTE_POINT_INSTALLERCONFIG_EQUIP_CONFIG,       m_equipConfig      );              
        registerTuple( STORM_RTE_POINT_INSTALLERCONFIG_COMP_COOL_STAGE1,   m_compCoolStage1   );  
        registerTuple( STORM_RTE_POINT_INSTALLERCONFIG_COMP_COOL_STAGE2,   m_compCoolStage2   );              
        registerTuple( STORM_RTE_POINT_INSTALLERCONFIG_COMP_HEAT_STAGE1,   m_compHeatStage1   );              
        registerTuple( STORM_RTE_POINT_INSTALLERCONFIG_COMP_HEAT_STAGE2,   m_compHeatStage2   );              
        registerTuple( STORM_RTE_POINT_INSTALLERCONFIG_ELEC_HEAT_STAGE1,   m_elecHeatStage1   );              
        registerTuple( STORM_RTE_POINT_INSTALLERCONFIG_ELEC_HEAT_STAGE2,   m_elecHeatStage2   );              
        registerTuple( STORM_RTE_POINT_INSTALLERCONFIG_ELEC_HEAT_STAGE3,   m_elecHeatStage3   );
        registerTuple( STORM_RTE_POINT_INSTALLERCONFIG_FOSSIL_HEAT_STAGE1, m_fossilHeatStage1 );              
        registerTuple( STORM_RTE_POINT_INSTALLERCONFIG_FOSSIL_HEAT_STAGE2, m_fossilHeatStage2 );              
        registerTuple( STORM_RTE_POINT_INSTALLERCONFIG_FOSSIL_HEAT_STAGE3, m_fossilHeatStage3 );              
        }
