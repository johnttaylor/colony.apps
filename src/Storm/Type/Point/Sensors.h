#ifndef Storm_Type_Point_Sensors_h_
#define Storm_Type_Point_Sensors_h_
/*-----------------------------------------------------------------------------
...
#include "Storm/Type/Tuple/Sensors.h"
...
namespace Storm
    ...
    namespace Type
        ...
        namespace Point
            ...
            #define STORM_TYPE_POINT_SENSORS_SENSORS     0   //!< Tuple Index
            #define STORM_TYPE_POINT_SENSORS_NUM_TUPLES  (Storm_Type_Point_SENSORS_SENSORS+1) //!< Number of Tuples


            /** RTE Point for the User operating mode, setpoints, fan mode, etc. a
                thermostat.
             */
            class Sensors : public Rte::Point::Basic<STORM_TYPE_POINT_SENSORS_NUM_TUPLES>
                {
                public:
                    /// Sensors Tuple
                ...
                public:
                    ...
                    Sensors( void )
                        {
                        registerTuple( Storm_Type_Point_SENSORS_SENSORS, m_sensors );
                        }
             ...
             */
            template <class CONTEXT>
            class SensorsLViewer : public Rte::Point::Null<STORM_TYPE_POINT_SENSORS_NUM_TUPLES>,
                public Rte::Point::Viewer::Composer<CONTEXT>
                {
                public:
                    /// Constructor
