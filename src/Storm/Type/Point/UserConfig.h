#ifndef Storm_Type_Point_UserConfig_h_
#define Storm_Type_Point_UserConfig_h_
/*-----------------------------------------------------------------------------
...
#include "Storm/Type/Tuple/UserConfig.h"
...
namespace Storm
    ...
    namespace Type
        ...
        namespace Point
            ...
            /*------------------------- POINTS ------------------------------------------*/
            #define STORM_TYPE_POINT_USER_CONFIG_CONFIG          0   //!< Tuple Index
            #define STORM_TYPE_POINT_USER_CONFIG_NUM_TUPLES      (Storm_Type_Point_USER_CONFIG_CONFIG+1)  //!< Number of Tuples


            /** RTE Point for the User operating mode, setpoints, fan mode, etc. a
                thermostat.
             */
            class UserConfig : public Rte::Point::Basic<STORM_TYPE_POINT_USER_CONFIG_NUM_TUPLES>
                {
                public:
                    /// UserConfig Tuple
                ...
                public:
                    ...
                    UserConfig( void )
                        {
                        registerTuple( Storm_Type_Point_USER_CONFIG_CONFIG, m_config );
                        }
             ...
             */
            template <class CONTEXT>
            class UserConfigLViewer : public Rte::Point::Null<STORM_TYPE_POINT_USER_CONFIG_NUM_TUPLES>,
                public Rte::Point::Viewer::Composer<CONTEXT>
                {
                public:
                    /// Constructor
